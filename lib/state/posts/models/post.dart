...
class Post {
  ...
  final Map<PostSettingEnum, bool> postSettings;
    ...
    required Map<String, dynamic> json,
        ...
        postSettings = {
          for (final entry in json[PostKey.postSettings].entries)
            PostSettingEnum.values.firstWhere(
              (element) => element.storageKey == entry.key,
            ): entry.value,
        };

  bool get allowLikes => postSettings[PostSettingEnum.allowLikes] ?? false;
  bool get allowComments => postSettings[PostSettingEnum.allowComments] ?? false;
}
